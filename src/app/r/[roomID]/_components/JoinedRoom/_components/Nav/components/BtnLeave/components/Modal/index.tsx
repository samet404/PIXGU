...
const Modal = () => {
  ...
  return (
    <div
      className={`${urbanist.className} absolute top-0 z-10 flex h-full w-full animate-fade items-center justify-center bg-[#000000a5] backdrop-blur-md animate-duration-200`}
    >
      <div
