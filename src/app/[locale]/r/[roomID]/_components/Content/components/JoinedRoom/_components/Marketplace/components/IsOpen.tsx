  ...
  if (openPanel === 'marketplace')
    return (
      <section
        ...
        className={`${outfit.className} absolute left-0 top-0 z-30 flex h-full w-full animate-fade-up flex-col items-start justify-end bg-[#0000004f]  bg-gradient-to-t from-[#cf076b] from-[35%] to-transparent backdrop-blur-sm animate-duration-200`}
      >
