...
const Me = () => {
  ...
  return (
    <div className="group group flex h-full w-full flex-col items-center justify-center rounded-lg bg-[#ffffff4b]">
      <div className={`flex w-full flex-row items-center justify-between p-2`}>
        <div className="flex w-full flex-row items-center gap-2 peer-hover:bg-red-200 ">
          {profilePicture ? (
            <Img src={profilePicture} />
          ) : (
            <div className="flex-shrink select-none rounded-full bg-white drop-shadow-[0_0px_5px_rgba(0,0,0,0.3)]"></div>
          )}
          <div
            className={`${urbanist.className} line-clamp-1  w-[70%] break-words text-sm tracking-wide text-[#ffffffd4] drop-shadow-[0_0px_2px_rgba(0,0,0,0.55)]`}
          >
