...
const MainButton = ({
  ...
  if (disabled && disabledDesc)
    return (
      <div className="relative h-full w-full">
        <div
          className={`${roundedClass} ${outfit.className} absolute z-10 flex h-full w-full items-center justify-center text-[#ffffff82] backdrop-blur-sm`}
        >
          {disabledDesc}
        </div>
