...
export const Modal = () => {
  ...
  return (
    <div
      ...
      className="absolute left-0 top-0 z-50 flex h-full w-full flex-col  items-center overflow-y-auto bg-[#0000005a] px-4 py-[20%] text-white backdrop-blur-lg selection:!bg-[#ffffffab] selection:text-blue-900"
    >
      <div
        onKeyDown={handleOnKeyDown}
        ref={ref}
        className={`${inter.className} flex animate-fade-up flex-col  gap-10 rounded-lg border-[0.25rem] border-pink-600 bg-gradient-to-tr from-[#ffffffb4] via-[#ffffff7a] to-[#ffffffb4] px-6 py-4 text-center text-blue-950 shadow-[0_0px_10px_1px_rgba(0,0,0,0.5)] `}
      >
        <Item
        ...
        <Item
          title="Add PIXGU to always active tabs"
          description={[
            'Most modern browsers have memory saver feature. This feature freed ups inactive tabs so you can use active tabs more fast. You can add PIXGU to always active tabs to prevent this from happening.',
          ]}
        />
