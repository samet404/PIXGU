...
const GradientContainer = ({ children }: { children: ReactNode }) => {
  return (
    <div className="animate-fade-down rounded-lg bg-gradient-to-tl from-[rgb(255,249,166)] via-[rgb(255,238,81)] to-[rgb(255,247,139)] p-1 shadow-[0_0px_30px_0px_#fcf93973] xxs:w-[90%]  sm:w-[30rem]">
