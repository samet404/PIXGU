...
const Login = () => {
  ...
  return (
    <Modal>
      <div
        ref={ref}
        className="flex h-full xxs:w-full md:w-[20rem] animate-fade-right flex-col items-center overflow-y-auto bg-[rgba(255,255,255,0.2)] px-1 pb-1 pt-4 shadow-[0_0px_80px_10px_rgba(0,0,0,0.8)] backdrop-blur-md animate-duration-[300ms] animate-once "
      >
        <Image
          src={Logo}
          alt="logo"
