...
const MainButton = ({
  ...
  return (
    <Link href={link} className={'select-none cursor-none'}>
      <button
        className={`${className} relative flex h-full w-full flex-col gap-3 bg-gradient-to-tr from-[rgba(255,255,255,0.4)] to-[rgba(255,255,255,0.3)] p-2 shadow-[0_0px_5px_0px_rgba(0,0,0,0.8)]`}
        {...rest}
      >
        <div
