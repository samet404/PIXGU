...
export const BuyMeCoffee = () => {
  return (
    <div
      className={`${ubuntu.className} group absolute bottom-2 left-2 z-[99] flex flex-row items-center rounded-full bg-gradient-to-r from-[#fcdf24] to-[#fff200] to-[50%] shadow-[0_0px_10px_1px_rgba(0,0,0,0.5)] backdrop-blur-lg`}
    >
      <Link
      ...
      <div className="hidden animate-fade pr-4 text-[0.7rem] text-black selection:!bg-black group-hover:flex">
        {`You can support me for full release. I have no money :(`}
      </div>
    </div>
  )
}
